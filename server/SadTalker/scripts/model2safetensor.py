...
audio2pose_checkpoint = os.path.join(current_root_path, 'SadTalker', 'checkpoints', 'audio2pose_00140-model.pth')
audio2pose_yaml_path = os.path.join(current_root_path, 'SadTalker', 'src', 'config', 'audio2pose.yaml')


audio2exp_checkpoint = os.path.join(current_root_path, 'SadTalker', 'checkpoints', 'audio2exp_00300-model.pth')
audio2exp_yaml_path = os.path.join(current_root_path, 'SadTalker', 'src', 'config', 'audio2exp.yaml')
