...
# wget -nc https://github.com/Winfredy/SadTalker/releases/download/v0.0.2/audio2exp_00300-model.pth -O ./checkpoints/audio2exp_00300-model.pth
# wget -nc https://github.com/Winfredy/SadTalker/releases/download/v0.0.2/audio2pose_00140-model.pth -O ./checkpoints/audio2pose_00140-model.pth
