...
audio2exp_checkpoint = os.path.join(current_root_path, 'checkpoints', 'audio2exp_00300-model.pth')
audio2exp_yaml_path = os.path.join(current_root_path, 'src', 'config', 'audio2exp.yaml')
